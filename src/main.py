...
df_tweets = pd.read_csv('../data/cleandata.csv')
...
# Now, write the sentiment scores to 'cleandata.csv' AFTER calculating and using them
df_tweets.to_csv('../data/cleandata.csv', index=False)
#-----------------------------------------------------------------------------------
...
df_stocks.to_csv('../data/TSLA.csv', index=False)
#--------------------------------------------------------------------
...
if 'Sentiment' not in df_stocks.columns:
    df_combined.to_csv('../data/TSLA.csv', index=False)
#---------------------------------------------------------------------------
